...
void test_tail_NULL(void) {
    struct ll_node* h = ll_tail(NULL);
    TEST_ASSERT_NULL(h);
}

void test_tail_10(void) {
    struct ll_node* h = ll_tail(list_10);

    TEST_ASSERT_NOT_NULL(h);
    TEST_ASSERT_EQUAL_INT(10, h->data);
}
void test_tail_10_11(void) {
    struct ll_node* h = ll_tail(list_10_11);

    TEST_ASSERT_NOT_NULL(h);
    TEST_ASSERT_EQUAL_INT(11, h->data);
}
void test_tail_10_13_11_12(void) {
    struct ll_node* h = ll_tail(list_10_13_11_12);
...
int main(void) {
    ...
    RUN_TEST(test_tail_NULL);
    RUN_TEST(test_tail_10);
    RUN_TEST(test_tail_10_11);
    RUN_TEST(test_tail_10_13_11_12);
